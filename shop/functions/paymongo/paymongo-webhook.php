    ...
    if ($data && isset($data['data']['attributes']['type'])) {
        ...
        if ($eventType == 'checkout_session.payment.paid' || $eventType == 'payment.paid') {
            try {
                ...
                if (!$paymongoPayID) {
                    throw new Exception("Invalid payment ID in webhook data");
                }
                ...
                if (empty($externalReferenceNumber)) {
                    throw new Exception("Missing reference number in metadata for payment: " . $paymongoPayID);
                }
                ...
                try {
                    ...
                    echo "Failed to process payment: Database error";
                }
                ...
                echo "Failed to process payment: " . $paymentEx->getMessage();
            }
        } else {
