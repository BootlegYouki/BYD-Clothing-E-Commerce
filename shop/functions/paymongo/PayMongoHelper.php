...
class PayMongoHelper {
    ...
    /**
     * Create a webhook for receiving payment notifications
     * 
     * @param string $url The URL that will receive the webhook events
    ...
    public function createWebhook($url, $events = ['payment.paid', 'payment.failed']) {
        ...
        return $this->makeRequest('POST', 'webhooks', $requestData);
    }
     ...
     * Enable a webhook
     * 
     * @param string $webhookId The ID of the webhook to enable
     * @return array Webhook data
     */
    public function enableWebhook($webhookId) {
        return $this->makeRequest('POST', "webhooks/$webhookId/enable");
    }
    
    /**
     * Disable a webhook
     * 
     * @param string $webhookId The ID of the webhook to disable
     * @return array Webhook data
     */
    public function disableWebhook($webhookId) {
        return $this->makeRequest('POST', "webhooks/$webhookId/disable");
    }
}