...
<head>
    ...
    <title>Beyond Doubt Clothing | Terms of Service</title> 
    <!-- BOOTSTRAP CSS/JS -->
        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>8. Account Verification and Security</strong><br>
                    For security purposes, we utilize One-Time Password (OTP) verification sent to your registered email address for certain transactions and account activities. You are responsible for maintaining the confidentiality of your OTP and account information. Any activities that occur under your account are your responsibility. We may collect location information that you provide during registration or checkout to improve service delivery and fraud prevention.</p>
